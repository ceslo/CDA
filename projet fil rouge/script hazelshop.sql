...
INSERT INTO type_client(id_type_client, libelle_client) VALUES (1, "Particulier");
INSERT INTO type_client(id_type_client, libelle_client) VALUES (2, "Professionnel");
...
INSERT INTO categorie ( id_categorie,  libelle_categorie, id_categorie_1)  VALUES (4, "Jeux coopératifs", 1);
INSERT INTO categorie ( id_categorie,  libelle_categorie, id_categorie_1)  VALUES (5, "Jeux non coopératifs", 1);
INSERT INTO categorie ( id_categorie,  libelle_categorie, id_categorie_1)  VALUES (6, "Jeux de cartes", 3);
INSERT INTO categorie ( id_categorie,  libelle_categorie, id_categorie_1)  VALUES (7, "Escape Box", 3);



INSERT INTO article ( id_article ,  libelle ,  description ,  img_article  ,  qte_stock ,  prix_achat,  id_categorie ) VALUES ( 1, "Cthulhu : Death May Die", "Cthulhu : Death May Die est un jeu de plateau coopératif au rythme endiablé pouvant réunir 1 à 5 participants. Pour vaincre les horreurs surnaturelles venues de par-delà le temps et l’espace, vous devrez oeuvrer de concert et accepter de sombrer dans la folie. 
...
Vous allez devoir interrompre le rituel juste le temps de rendre le Grand Ancien vulnérable. Et vous allez le tuer. Une bonne fois pour toutes." , "cthulhu-death-may-die.webp", 15, "79.92", 4);


INSERT INTO article (id_article, libelle, description, img_article, qte_stock, prix_achat, id_categorie) VALUES ( 2, "The Descent: Legendes des Ténèbres" , "Pendant des années, vos voyages vous ont mené à travers le royaume fantastique de Terrinoth, vous aventurant dans des forêts sombres, des villes obscures, des cryptes anciennes et des marais brumeux... mais votre véritable voyage légendaire ne fait que commencer… Forgez votre propre légende avec vos amis en vous aventurant à travers le royaume fantastique de Terrinoth dans Descent : Legends of the Dark, le jeu de plateau coopératif par excellence pour un à quatre joueurs ! Grâce à son application gratuite entièrement intégrée, Descent : Legends of the Dark vous met dans le rôle d un héros en herbe avec son propre style de jeu et ses propres capacités.", "descent-legendes-des-tenebres.webp", 2, "135.90", "4");
INSERT INTO article (id_article, libelle, description, img_article, qte_stock, prix_achat, id_categorie) VALUES (3, "Arkeis",  "Arkeis est un jeu narratif et coopératif utilisant des figurines, dans lequel les joueurs explorent d’anciennes ruines égyptiennes. Le jeu est prévu pour être joué en campagne où chaque décision prise et chaque objet récupéré peut avoir une influence importante sur l’histoire qui se déroule. Chaque scénario s’accompagne d’objectifs que les joueurs peuvent remplir durant la partie. Compléter ces missions les récompensera avec de nouveaux objets importants ou de nouveaux pouvoirs qui influenceront les scénarios suivants. Il faudra une équipe de joueurs vétérans pour réussir à découvrir tous les secrets d’Arkeis !", "arkeis.webp", 3 , "74.92", 4);
INSERT INTO article (id_article, libelle, description, img_article, qte_stock, prix_achat, id_categorie) VALUES ( 4, "Cyclades", "Dans les Cyclades la lutte pour faire rayonner votre cité sera terrible !
...
INSERT INTO commande(date_commande,coef_client, total, frais_port, mode_paiement, delais_reglement, montant_regle, id_facture, statut, id_adresse, id_client) VALUES ("2020-09-06",1.35, 25.43, 4.90, "CB", "0", 30.33, 1, "livrée", 1, 1);

INSERT INTO commande(date_commande,coef_client, total, frais_port, mode_paiement, delais_reglement,montant_regle, id_facture, statut, id_adresse, id_client) VALUES ("2021-12-20",1.2, 265.90, 4.90,  "virement", "30",270.80, 1, "livrée", 2, 2) ;
INSERT INTO commande(date_commande,coef_client, total, frais_port, mode_paiement, delais_reglement,montant_regle, id_facture, statut, id_adresse, id_client) VALUES ("2021-12-20",1.2, 265.90, 4.90,  "virement", "30",270.80, 1, "livrée", 2, 2) ;
INSERT INTO commande(date_commande,coef_client, total, frais_port, mode_paiement, delais_reglement,montant_regle, id_facture, statut, id_adresse, id_client) VALUES ("2021-12-20",1.2, 265.90, 4.90,  "virement", "30",270.80, 1, "livrée", 2, 2) ;
...
INSERT INTO details_fournisseur(id_article, id_fournisseur, ref_fournisseur, prix_achat) VALUES (1,1,"C04404",79.92);
INSERT INTO details_fournisseur(id_article, id_fournisseur, ref_fournisseur, prix_achat) VALUES (2,1,"C04405",135.90);
INSERT INTO details_fournisseur(id_article, id_fournisseur, ref_fournisseur, prix_achat) VALUES (3,1,"C04406",74.92);
INSERT INTO details_fournisseur(id_article, id_fournisseur, ref_fournisseur, prix_achat) VALUES (4,1,"NC6078",50.50);

INSERT INTO details_fournisseur(id_article, id_fournisseur, ref_fournisseur, prix_achat) VALUES (5,2,"A50756",15.84);

INSERT INTO details_fournisseur(id_article, id_fournisseur, ref_fournisseur, prix_achat) VALUES (6,2,"A50789",18.84);

INSERT INTO details_fournisseur(id_article, id_fournisseur, ref_fournisseur, prix_achat) VALUES (7,3,"E32089",25.42);

INSERT INTO details_fournisseur(id_article, id_fournisseur, ref_fournisseur, prix_achat) VALUES (8,3,"E32090",25.42);

INSERT INTO details_fournisseur(id_article, id_fournisseur, ref_fournisseur, prix_achat) VALUES (9,3,"CB0789",35.42);

INSERT INTO details_fournisseur(id_article, id_fournisseur, ref_fournisseur, prix_achat) VALUES (10,3,"CB0791",35.42);
...
INSERT INTO adresse_livraison(id_commande, id_adresse) VALUES (1,1);
INSERT INTO adresse_livraison(id_commande, id_adresse) VALUES (2,2);